...
class SiteController extends Controller
{
    ...
    {
        $parent_id = ( isset(Yii::$app->request->queryParams["parent_id"]) ? Yii::$app->request->queryParams["parent_id"] : 0 );

        try {
            $model = Categories::getCategories($parent_id);
            $modelParent = Categories::getCategoriesParent($parent_id);            
        } catch (InvalidParamException $e) {
            throw new BadRequestHttpException($e->getMessage());
        }
        ...
        $products = Products::getProductByCatId( ( $modelParent ? $modelParent['id'] : 0 ) );
